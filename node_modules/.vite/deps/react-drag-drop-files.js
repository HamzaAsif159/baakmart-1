...
function stylis_min(W2) {
  function M2(d3, c3, e3, h3, a3) {
    for (var m2 = 0, b3 = 0, v3 = 0, n3 = 0, q2, g3, x3 = 0, K2 = 0, k3, u3 = k3 = q2 = 0, l3 = 0, r3 = 0, I2 = 0, t2 = 0, B3 = e3.length, J2 = B3 - 1, y3, f2 = "", p2 = "", F3 = "", G3 = "", C2; l3 < B3; ) {
      g3 = e3.charCodeAt(l3);
      l3 === J2 && 0 !== b3 + n3 + v3 + m2 && (0 !== b3 && (g3 = 47 === b3 ? 10 : 47), n3 = v3 = m2 = 0, B3++, J2++);
      if (0 === b3 + n3 + v3 + m2) {
        ...
        switch (g3) {
          case 123:
            ...
            switch (q2) {
              case 64:
                ...
                t2 = k3.length;
                0 < A2 && (r3 = X2(O, f2, I2), C2 = H3(3, k3, r3, c3, D2, z3, t2, g3, a3, h3), f2 = r3.join(""), void 0 !== C2 && 0 === (t2 = (k3 = C2.trim()).length) && (g3 = 0, k3 = ""));
                if (0 < t2)
                  switch (g3) {
                    case 115:
                      f2 = f2.replace(da, ea);
                ...
                break;
              default:
                k3 = M2(c3, X2(c3, f2, I2), k3, h3, a3 + 1);
            }
            F3 += k3;
            k3 = I2 = r3 = u3 = q2 = 0;
            f2 = "";
          ...
          case 59:
            ...
            if (1 < (t2 = f2.length))
              switch (0 === u3 && (q2 = f2.charCodeAt(0), 45 === q2 || 96 < q2 && 123 > q2) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A2 && void 0 !== (C2 = H3(1, f2, c3, d3, D2, z3, p2.length, h3, a3, h3)) && 0 === (t2 = (f2 = C2.trim()).length) && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g3 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if (105 === g3 || 99 === g3) {
                ...
                default:
                  58 !== f2.charCodeAt(t2 - 1) && (p2 += P2(f2, q2, g3, f2.charCodeAt(2)));
              }
            I2 = r3 = u3 = q2 = 0;
            f2 = "";
            g3 = e3.charCodeAt(++l3);
      ...
      switch (g3) {
        case 13:
        case 10:
          47 === b3 ? b3 = 0 : 0 === 1 + q2 && 107 !== h3 && 0 < f2.length && (r3 = 1, f2 += "\0");
          0 < A2 * Y2 && H3(0, f2, c3, d3, D2, z3, p2.length, h3, a3, h3);
          z3 = 1;
          D2++;
          break;
        case 59:
        ...
        default:
          ...
          switch (g3) {
            ...
            case 11:
              ...
              break;
            case 38:
              0 === n3 + b3 + m2 && (r3 = I2 = 1, y3 = "\f" + y3);
              break;
            case 108:
              if (0 === n3 + b3 + m2 + E3 && 0 < u3)
                switch (l3 - u3) {
                  case 2:
    ...
    if (0 < t2) {
      r3 = c3;
      if (0 < A2 && (C2 = H3(2, p2, r3, d3, D2, z3, t2, h3, a3, h3), void 0 !== C2 && 0 === (p2 = C2).length))
        return G3 + p2 + F3;
      p2 = r3.join(",") + "{" + p2 + "}";
      if (0 !== w3 * E3) {
        2 !== w3 || L3(p2, 2) || (E3 = 0);
  ...
  function X2(d3, c3, e3) {
    ...
    c3 = h3;
    var a3 = h3.length, m2 = d3.length;
    switch (m2) {
      case 0:
      case 1:
        var b3 = 0;
        for (d3 = 0 === m2 ? "" : d3[0] + " "; b3 < a3; ++b3) {
  ...
  function P2(d3, c3, e3, h3) {
    ...
    switch (m2) {
      ...
      case 953:
        if (true === la.test(d3))
          return 115 === (b3 = d3.substring(d3.indexOf(":") + 1)).charCodeAt(0) ? P2(d3.replace("stretch", "fill-available"), c3, e3, h3).replace(":fill-available", ":stretch") : a3.replace(b3, "-webkit-" + b3) + a3.replace(b3, "-moz-" + b3.replace("fill-", "")) + a3;
        break;
      case 962:
        if (a3 = "-webkit-" + a3 + (102 === a3.charCodeAt(5) ? "-ms-" + a3 : "") + a3, 211 === e3 + h3 && 105 === a3.charCodeAt(13) && 0 < a3.indexOf("transform", 10))
  ...
  function B2(d3, c3) {
    ...
    e3 = [V2];
    if (0 < A2) {
      var h3 = H3(-1, c3, e3, e3, D2, z3, 0, 0, 0, 0);
      void 0 !== h3 && "string" === typeof h3 && (c3 = h3);
    }
    var a3 = M2(O, e3, c3, 0, 0);
    0 < A2 && (h3 = H3(-2, a3, e3, e3, D2, z3, a3.length, 0, 0, 0), void 0 !== h3 && (a3 = h3));
    V2 = "";
    E3 = 0;
    z3 = D2 = 1;
    return a3;
  }
  var ca = /^\0+/g, N2 = /[\0\r\f]/g, aa = /: */g, ka = /zoo|gra/, ma = /([,: ])(transform)/g, ia = /,\r+?/g, F2 = /([\t\r\n ])*\f?&/g, fa = /@(k\w+)\s*(\S*)\s*/, Q2 = /::(place)/g, ha = /:(read-only)/g, G2 = /[svh]\w+-[tblr]{2}/, da = /\(\s*(.*)\s*\)/g, oa = /([\s\S]*?);/g, ba = /-self|flex-/g, na = /[^]*?(:[rp][el]a[\w-]+)[^]*/, la = /stretch|:\s*\w+\-(?:conte|avail)/, ja = /([^-])(image-set\()/, z3 = 1, D2 = 1, E3 = 0, w3 = 1, O = [], S2 = [], A2 = 0, R2 = null, Y2 = 0, V2 = "";
  B2.use = T2;
  B2.set = U2;
  void 0 !== W2 && U2(W2);
  return B2;
...
function j(e3) {
  ...
  throw false ? new Error("An error occurred. See https://git.io/JUIaE#" + e3 + " for more information." + (n3.length > 0 ? " Args: " + n3.join(", ") : "")) : new Error(D.apply(void 0, [R[e3]].concat(n3)).trim());
}
var T = function() {
  function e3(e4) {
...
var B = function(e3) {
  ...
  for (; k.has(V); )
    V++;
  var t2 = V++;
  return ((0 | t2) < 0 || t2 > 1 << 30) && j(16, "" + t2), x.set(e3, t2), k.set(t2, e3), t2;
};
var z = function(e3) {
  return k.get(e3);
};
var M = function(e3, t2) {
  t2 >= V && (V = t2 + 1), x.set(e3, t2), k.set(t2, e3);
};
var G = "style[" + A + '][data-styled-version="5.3.9"]';
var L = new RegExp("^" + A + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)');
var F = function(e3, t2, n3) {
  ...
  for (var n3 = (t2.textContent || "").split("/*!sc*/\n"), r3 = [], o2 = 0, s3 = n3.length; o2 < s3; o2++) {
    ...
    if (i3) {
      ...
      if (a3) {
        ...
        0 !== c3 && (M(u3, c3), F(e3, u3, a3[3]), e3.getTag().insertRules(c3, r3)), r3.length = 0;
      } else
        r3.push(i3);
    }
  }
...
var Z = function() {
  function e3(e4, t3, n3) {
    void 0 === e4 && (e4 = E), void 0 === t3 && (t3 = {}), this.options = v({}, X, {}, e4), this.gs = t3, this.names = new Map(n3), this.server = !!e4.isServer, !this.server && I && J && (J = false, function(e5) {
  ...
  return t2.reconstructWithOptions = function(t3, n3) {
    return void 0 === n3 && (n3 = true), new e3(v({}, this.options, {}, t3), this.gs, n3 && this.names || void 0);
  }, t2.allocateGSInstance = function(e4) {
    return this.gs[e4] = (this.gs[e4] || 0) + 1;
  }, t2.getTag = function() {
    return this.tag || (this.tag = (n3 = (t3 = this.options).isServer, r3 = t3.useCSSOMInjection, o2 = t3.target, e4 = n3 ? new U(o2) : r3 ? new $(o2) : new W(o2), new T(e4)));
    var e4, t3, n3, r3, o2;
    ...
    this.registerName(e4, t3), this.getTag().insertRules(B(e4), n3);
...
var se = function() {
  function e3(e4, t2, n3) {
    this.rules = e4, this.staticRulesId = "", this.isStatic = false, this.componentId = t2, this.baseHash = te(oe, t2), this.baseStyle = n3, Z.registerId(t2);
  }
  return e3.prototype.generateAndInjectStyles = function(e4, t2, n3) {
    ...
    if (this.baseStyle && o2.push(this.baseStyle.generateAndInjectStyles(e4, t2, n3)), this.isStatic && !n3.hash)
      if (this.staticRulesId && t2.hasNameForId(r3, this.staticRulesId))
        ...
        var s3 = Ne(this.rules, e4, t2, n3).join(""), i3 = ee(te(this.baseHash, s3) >>> 0);
      ...
      for (var c3 = this.rules.length, u3 = te(this.baseHash, n3.hash), l3 = "", d3 = 0; d3 < c3; d3++) {
        ...
        if ("string" == typeof h3)
          ...
          var p2 = Ne(h3, e4, t2, n3), f2 = Array.isArray(p2) ? p2.join("") : p2;
      ...
      if (l3) {
        ...
        if (!t2.hasNameForId(r3, m2)) {
          var y3 = n3(l3, "." + m2, void 0, r3);
          t2.insertRules(r3, m2, y3);
        }
        o2.push(m2);
      }
    }
...
var ae = [":", "[", ".", "#"];
function ce(e3) {
  var t2, n3, r3, o2, s3 = void 0 === e3 ? E : e3, i3 = s3.options, a3 = void 0 === i3 ? E : i3, c3 = s3.plugins, u3 = void 0 === c3 ? w : c3, l3 = new stylis_browser_esm_default(a3), d3 = [], h3 = function(e4) {
    function t3(t4) {
      if (t4)
        try {
          e4(t4 + "}");
    ...
    return 0 === r4 && -1 !== ae.indexOf(s4[n3.length]) || s4.match(o2) ? e4 : "." + t2;
  };
  ...
  }])), m2.hash = u3.length ? u3.reduce(function(e4, t3) {
    return t3.name || j(15), te(e4, t3.name);
  }, 5381).toString() : "", m2;
}
...
function ye(e3) {
  var t2 = (0, import_react.useState)(e3.stylisPlugins), n3 = t2[0], s3 = t2[1], c3 = fe(), u3 = (0, import_react.useMemo)(function() {
    var t3 = c3;
    ...
    return ce({ options: { prefix: !e3.disableVendorPrefixes }, plugins: n3 });
...
function Ne(e3, n3, r3, o2) {
  if (Array.isArray(e3)) {
    for (var s3, i3 = [], a3 = 0, c3 = e3.length; a3 < c3; a3 += 1)
      "" !== (s3 = Ne(e3[a3], n3, r3, o2)) && (Array.isArray(s3) ? i3.push.apply(i3, s3) : i3.push(s3));
    return i3;
  }
  if (_e(e3))
    return "";
  ...
  if (b(e3)) {
    if ("function" != typeof (l3 = e3) || l3.prototype && l3.prototype.isReactComponent || !n3)
      return e3;
    var u3 = e3(n3);
    return (0, import_react_is.isElement)(u3) && console.warn(_(e3) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u3, n3, r3, o2);
  }
  var l3;
  return e3 instanceof ve ? r3 ? (e3.inject(r3, o2), e3.getName(o2)) : e3 : S(e3) ? function e4(t2, n4) {
    var r4, o3, s4 = [];
    for (var i4 in t2)
      t2.hasOwnProperty(i4) && !_e(t2[i4]) && (Array.isArray(t2[i4]) && t2[i4].isCss || b(t2[i4]) ? s4.push(be(i4) + ":", t2[i4], ";") : S(t2[i4]) ? s4.push.apply(s4, e4(t2[i4], i4)) : s4.push(be(i4) + ": " + (r4 = i4, null == (o3 = t2[i4]) || "boolean" == typeof o3 || "" === o3 ? "" : "number" != typeof o3 || 0 === o3 || r4 in unitless_browser_esm_default ? String(o3).trim() : o3 + "px") + ";"));
...
function Ce(e3) {
  for (var t2 = arguments.length, n3 = new Array(t2 > 1 ? t2 - 1 : 0), r3 = 1; r3 < t2; r3++)
    n3[r3 - 1] = arguments[r3];
  return b(e3) || S(e3) ? Ae(Ne(g(w, [e3].concat(n3)))) : 0 === n3.length && 1 === e3.length && "string" == typeof e3[0] ? e3 : Ae(Ne(g(e3, n3)));
}
...
var Oe = function(e3, t2) {
  if (true) {
    ...
    try {
      ...
      }, (0, import_react.useRef)(), o2 && !Pe.has(n3) && (console.warn(n3), Pe.add(n3));
    } catch (e4) {
      Ie.test(e4.message) && Pe.delete(n3);
    } finally {
      console.error = r3;
    }
  }
};
var Re = function(e3, t2, n3) {
  return void 0 === n3 && (n3 = E), e3.theme !== n3.theme && e3.theme || t2 || n3.theme;
};
var De = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g;
var je = /(^-|-$)/g;
function Te(e3) {
...
var Le = Ge.Consumer;
var Ye = {};
function qe(e3, t2, n3) {
  var o2 = N(e3), i3 = !ke(e3), a3 = t2.attrs, c3 = void 0 === a3 ? w : a3, d3 = t2.componentId, h3 = void 0 === d3 ? function(e4, t3) {
    var n4 = "string" != typeof e4 ? "sc" : Te(e4);
    Ye[n4] = (Ye[n4] || 0) + 1;
    var r3 = n4 + "-" + xe("5.3.9" + n4 + Ye[n4]);
    return t3 ? t3 + "-" + r3 : r3;
  }(t2.displayName, t2.parentComponentId) : d3, p2 = t2.displayName, f2 = void 0 === p2 ? function(e4) {
    return ke(e4) ? "styled." + e4 : "Styled(" + _(e4) + ")";
  }(e3) : p2, g3 = t2.displayName && t2.componentId ? Te(t2.displayName) + "-" + t2.componentId : t2.componentId || h3, S2 = o2 && e3.attrs ? Array.prototype.concat(e3.attrs, c3).filter(Boolean) : c3, A2 = t2.shouldForwardProp;
  o2 && e3.shouldForwardProp && (A2 = t2.shouldForwardProp ? function(n4, r3, o3) {
    return e3.shouldForwardProp(n4, r3, o3) && t2.shouldForwardProp(n4, r3, o3);
  } : e3.shouldForwardProp);
  var C2, I2 = new se(n3, g3, o2 ? e3.componentStyle : void 0), P2 = I2.isStatic && 0 === c3.length, O = function(e4, t3) {
    return function(e5, t4, n4, r3) {
      var o3 = e5.attrs, i4 = e5.componentStyle, a4 = e5.defaultProps, c4 = e5.foldedComponentIds, d4 = e5.shouldForwardProp, h4 = e5.styledComponentId, p3 = e5.target;
      (0, import_react.useDebugValue)(h4);
      var f3 = function(e6, t5, n5) {
        void 0 === e6 && (e6 = E);
        var r4 = v({}, t5, { theme: e6 }), o4 = {};
      ...
      }(Re(t4, (0, import_react.useContext)(Ge), a4) || E, t4, o3), y3 = f3[0], g4 = f3[1], S3 = function(e6, t5, n5, r4) {
        var o4 = fe(), s3 = me(), i5 = t5 ? e6.generateAndInjectStyles(E, o4, s3) : e6.generateAndInjectStyles(n5, o4, s3);
        return (0, import_react.useDebugValue)(i5), !t5 && r4 && r4(i5), i5;
      }(i4, r3, y3, true ? e5.warnTooManyClasses : void 0), w3 = n4, _2 = g4.$as || t4.$as || g4.as || t4.as || p3, N2 = ke(_2), A3 = g4 !== t4 ? v({}, t4, {}, g4) : t4, C3 = {};
      for (var I3 in A3)
        "$" !== I3[0] && "as" !== I3 && ("forwardedAs" === I3 ? C3.as = A3[I3] : (d4 ? d4(I3, emotion_is_prop_valid_esm_default, _2) : !N2 || emotion_is_prop_valid_esm_default(I3)) && (C3[I3] = A3[I3]));
      return t4.style && g4.style !== t4.style && (C3.style = v({}, t4.style, {}, g4.style)), C3.className = Array.prototype.concat(c4, h4, S3 !== h4 ? S3 : null, t4.className, g4.className).filter(Boolean).join(" "), C3.ref = w3, (0, import_react.createElement)(_2, C3);
    }(C2, e4, t3, P2);
  };
  return O.displayName = f2, (C2 = import_react.default.forwardRef(O)).attrs = S2, C2.componentStyle = I2, C2.displayName = f2, C2.shouldForwardProp = A2, C2.foldedComponentIds = o2 ? Array.prototype.concat(e3.foldedComponentIds, e3.styledComponentId) : w, C2.styledComponentId = g3, C2.target = o2 ? e3.target : e3, C2.withComponent = function(e4) {
    var r3 = t2.componentId, o3 = function(e5, t3) {
      ...
      return o4;
    }(t2, ["componentId"]), s3 = r3 && r3 + "-" + (ke(e4) ? e4 : Te(_(e4)));
    return qe(e4, v({}, o3, { attrs: S2, componentId: s3 }), n3);
  }, Object.defineProperty(C2, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(t3) {
    this._foldedDefaultProps = o2 ? Me({}, e3.defaultProps, t3) : t3;
  } }), Oe(f2, g3), C2.warnTooManyClasses = function(e4, t3) {
    var n4 = {}, r3 = false;
    return function(o3) {
...
var He = function(e3) {
  return function e4(t2, r3, o2) {
    ...
    return s3.withConfig = function(n3) {
      return e4(t2, r3, v({}, o2, {}, n3));
    }, s3.attrs = function(n3) {
      return e4(t2, r3, v({}, o2, { attrs: Array.prototype.concat(o2.attrs, n3).filter(Boolean) }));
    }, s3;
  }(qe, e3);
};
...
var $e = function() {
  function e3(e4, t3) {
    this.rules = e4, this.componentId = t3, this.isStatic = re(e4), Z.registerId(this.componentId + 1);
  }
  var t2 = e3.prototype;
  return t2.createStyles = function(e4, t3, n3, r3) {
    var o2 = r3(Ne(this.rules, t3, n3, r3).join(""), ""), s3 = this.componentId + e4;
    ...
    e4 > 2 && Z.registerId(this.componentId + e4), this.removeStyles(e4, n3), this.createStyles(e4, t3, n3, r3);
  }, e3;
}();
var Je = function() {
  function e3() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (!t3)
        return "";
      var n3 = q();
      return "<style " + [n3 && 'nonce="' + n3 + '"', A + '="true"', 'data-styled-version="5.3.9"'].filter(Boolean).join(" ") + ">" + t3 + "</style>";
      ...
      if (e4.sealed)
        return j(2);
      var n3 = ((t3 = {})[A] = "", t3["data-styled-version"] = "5.3.9", t3.dangerouslySetInnerHTML = { __html: e4.instance.toString() }, t3), o2 = q();
      return o2 && (n3.nonce = o2), [import_react.default.createElement("style", v({}, n3, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e4.sealed = true;
...
var m = styled_components_browser_esm_default.div(f || (f = d2(["\n  border: dashed 2px ", ";\n  border-radius: 5px;\n  background-color: ", ";\n  opacity: 0.5;\n  position: absolute;\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  & > span {\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translateX(-50%) translateY(-50%);\n  }\n"], ["\n  border: dashed 2px ", ";\n  border-radius: 5px;\n  background-color: ", ";\n  opacity: 0.5;\n  position: absolute;\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  & > span {\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translateX(-50%) translateY(-50%);\n  }\n"])), "#666", "#999");
var b2 = styled_components_browser_esm_default.div(v2 || (v2 = d2(["\n  display: flex;\n  justify-content: space-between;\n  flex-grow: 1;\n  & > span {\n    font-size: 12px;\n    color: ", ";\n  }\n  .file-types {\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    max-width: 100px;\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  flex-grow: 1;\n  & > span {\n    font-size: 12px;\n    color: ", ";\n  }\n  .file-types {\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    max-width: 100px;\n  }\n"])), function(n3) {
  return n3.error ? "red" : "#666";
});
var w2 = styled_components_browser_esm_default.span(h2 || (h2 = d2(["\n  font-size: 14px;\n  color: ", ";\n  span {\n    text-decoration: underline;\n  }\n"], ["\n  font-size: 14px;\n  color: ", ";\n  span {\n    text-decoration: underline;\n  }\n"])), "#666");
var y2 = function(n3) {
  return n3 / 1e3 / 1e3;
};
var z2 = function(n3) {
...
var E2 = function(t2) {
  var o2 = t2.name, d3 = t2.hoverTitle, c3 = t2.types, u3 = t2.handleChange, f2 = t2.classes, v3 = t2.children, h3 = t2.maxSize, x3 = t2.minSize, w3 = t2.fileOrFiles, E3 = t2.onSizeError, S2 = t2.onTypeError, V2 = t2.onSelect, D2 = t2.onDrop, P2 = t2.disabled, j2 = t2.label, F2 = t2.multiple, O = t2.required, R2 = t2.onDraggingStateChange, T2 = t2.dropMessageStyle, M2 = (0, import_react2.useRef)(null), U2 = (0, import_react2.useRef)(null), Z2 = (0, import_react2.useState)(false), q2 = Z2[0], N2 = Z2[1], X2 = (0, import_react2.useState)(null), Y2 = X2[0], B2 = X2[1], A2 = (0, import_react2.useState)(false), G2 = A2[0], I2 = A2[1], J2 = function(n3) {
    return c3 && !function(n4, e3) {
      var r3 = n4.name.split(".").pop();
      return e3.map(function(n5) {
        return n5.toLowerCase();
      }).includes(r3.toLowerCase());
    }(n3, c3) ? (I2(true), S2 && S2("File type is not supported"), false) : h3 && y2(n3.size) > h3 ? (I2(true), E3 && E3("File size is too big"), false) : !(x3 && y2(n3.size) < x3) || (I2(true), E3 && E3("File size is too small"), false);
  }, K2 = function(n3) {
    var e3 = false;
    if (n3) {
    ...
    }, []), h4 = (0, import_react2.useCallback)(function(n4) {
    ...
    return (0, import_react2.useEffect)(function() {
      var n4 = e3.current;
      return n4.addEventListener("click", u4), n4.addEventListener("dragenter", f3), n4.addEventListener("dragleave", v4), n4.addEventListener("dragover", h4), n4.addEventListener("drop", x4), function() {
        n4.removeEventListener("click", u4), n4.removeEventListener("dragenter", f3), n4.removeEventListener("dragleave", v4), n4.removeEventListener("dragover", h4), n4.removeEventListener("drop", x4);
      };
    }, [u4, f3, v4, h4, x4, e3]), d4;
  ...
  }, [w3]), (0, import_jsx_runtime.jsxs)(g2, p({ overRide: v3, className: "".concat(f2 || "", " ").concat(P2 ? "is-disabled" : ""), ref: M2, htmlFor: o2, onClick: function(n3) {
    n3.preventDefault(), n3.stopPropagation();
  } }, { children: [(0, import_jsx_runtime.jsx)("input", { onClick: function(n3) {
    n3.stopPropagation(), U2 && U2.current && U2.current.click();
  }, onChange: function(n3) {
    var e3 = n3.target.files, r3 = F2 ? e3 : e3[0], t3 = K2(r3);
    V2 && t3 && V2(r3);
  }, accept: z2(c3), ref: U2, type: "file", name: o2, disabled: P2, multiple: F2, required: O }, void 0), Q2 && (0, import_jsx_runtime.jsx)(m, p({ style: T2 }, { children: (0, import_jsx_runtime.jsx)("span", { children: d3 || "Drop Here" }, void 0) }), void 0), !v3 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)(C, {}, void 0), (0, import_jsx_runtime.jsxs)(b2, p({ error: G2 }, { children: [k2(Y2, q2, G2, P2, j2), (0, import_jsx_runtime.jsx)(L2, { types: c3, minSize: x3, maxSize: h3 }, void 0)] }), void 0)] }, void 0), v3] }), void 0);
};
export {
  E2 as FileUploader
};
